...
const _R82_ptEDmwIdIGgEgikk0HWDTIBfTQZGNQJIVAQDkKU = (nitroApp) => {
...
_R82_ptEDmwIdIGgEgikk0HWDTIBfTQZGNQJIVAQDkKU,
...
const _lazy_7rA80T = () => Promise.resolve().then(function () { return index_get$3; });
...
const _lazy_y_raSL = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__nuxt_error', handler: _lazy_y_raSL, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/**', handler: _lazy_y_raSL, lazy: true, middleware: false, method: undefined }
];
...
const _id__put$2 = defineEventHandler(async (event) => {
  ...
  try {
    ...
    console.error(...oo_tx$6(`649552968_25_4_25_24_11`, error));
...
const index_post$2 = defineEventHandler(async (event) => {
  try {
    ...
    console.error(...oo_tx$4(`407644965_23_4_23_24_11`, error));
