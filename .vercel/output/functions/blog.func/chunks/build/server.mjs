import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, inject, ref, computed, toValue as toValue$1, watch, createVNode, resolveDynamicComponent, unref, mergeProps, withCtx, renderSlot, createBlock, openBlock, toDisplayString, hasInjectionContext, customRef, h, getCurrentInstance, toHandlerKey, camelize, createCommentVNode, Teleport, shallowRef, resolveComponent, toRef as toRef$1, isRef, useSlots, onServerPrefetch, provide, watchEffect, markRaw, toRefs, mergeModels, useModel, createTextVNode, Comment, cloneVNode, getCurrentScope, onScopeDispose, useAttrs, useTemplateRef, nextTick, Fragment, reactive, readonly, defineAsyncComponent, createElementBlock, useSSRContext, shallowReactive, Suspense, createApp, renderList, useId, onErrorCaptured, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, normalizeProps, guardReactiveProps, normalizeStyle } from 'vue';
import { v as defu, p as parseQuery, x as klona, y as defuFn, z as hasProtocol, A as isScriptProtocol, B as joinURL, w as withQuery, C as sanitizeStatusCode, D as withTrailingSlash, E as withoutTrailingSlash, F as getContext, e as createError$1, G as withLeadingSlash, H as parseURL, $ as $fetch$1, I as baseURL, J as createHooks, K as executeAsync, L as toRouteMatcher, M as createRouter$1, N as encodeParam, O as encodePath } from '../_/nitro.mjs';
...
import { useMounted, reactiveOmit as reactiveOmit$1, reactivePick, unrefElement, useDebounceFn, defaultWindow, onKeyStroke, createSharedComposable, useVModel, useRafFn } from '@vueuse/core';
...
const unhead_SgsuDadmif54CqIHnxfo2E2jlmyD0mDWCTEU37nK8_A = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const __nuxt_page_meta$1 = {
  layout: "dashboard-layout",
  headerAction: {
    label: "Supprimer un abonné",
    to: "/admin/followers/delete",
    class: "bg-red-600 text-white hover:bg-blue-700"
  }
};
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BYYGX8Mv.mjs')
  },
  {
    name: "blog-id",
    path: "/blog/:id()",
    component: () => import('./_id_-CSFuwqtX.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import('./login-CtDs2kR9.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-9WnbV5AS.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./index-CUJtGPDe.mjs')
  },
  {
    name: "admin-articles",
    path: "/admin/articles",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./articles-C7D6e-nJ.mjs')
  },
  {
    name: "admin-followers",
    path: "/admin/followers",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./followers-D2fVamCl.mjs')
  },
  {
    name: "admin-categories",
    path: "/admin/categories",
    meta: __nuxt_page_meta || {},
    component: () => import('./categories-CfiWL_qI.mjs')
  }
];
...
const revive_payload_server_DY_CJTutJ_HaiBGqBwFKyBzi9UDDCGAxJU7RFXr1aJo = /* @__PURE__ */ defineNuxtPlugin({
...
const colors_4iIq7uNt5GO47WRqNk09EnH5dDgOnoOW3pAejiGUXTw = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugin_QPxOMBS6QhJ8cjA3a3vblyTvwB96EtPx0H5_Tz75SXU = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
const plugins = [
  unhead_SgsuDadmif54CqIHnxfo2E2jlmyD0mDWCTEU37nK8_A,
  plugin,
  revive_payload_server_DY_CJTutJ_HaiBGqBwFKyBzi9UDDCGAxJU7RFXr1aJo,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8,
  colors_4iIq7uNt5GO47WRqNk09EnH5dDgOnoOW3pAejiGUXTw,
  plugin_server_1VsdcVlQN2tv6RG6Fy0EvkojZKbQX61TrTVJeEFBIfo,
  plugin_QPxOMBS6QhJ8cjA3a3vblyTvwB96EtPx0H5_Tz75SXU
];
...
_sfc_main$e.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_a492382add45b93319e14cad668e3015/node_modules/@nuxt/ui/dist/runtime/components/Icon.vue");
...
const ipxRuntime$hRlvJ418l_45ocDmBmVvQEWDoDL_iTRcxE_45nhuuMoSXUw = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$hRlvJ418l_45ocDmBmVvQEWDoDL_iTRcxE_45nhuuMoSXUw, defaults: {} }
  }
};
...
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+image@2.0.0_db0@0.3.4_1072e1c6bd38499bd3dda16161e43991/node_modules/@nuxt/image/dist/runtime/components/NuxtImg.vue");
  return _sfc_setup$d ? _sfc_setup$d(props, ctx) : void 0;
};
const __nuxt_component_4 = Object.assign(_sfc_main$d, { __name: "NuxtImg" });
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_a492382add45b93319e14cad668e3015/node_modules/@nuxt/ui/dist/runtime/components/Chip.vue");
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.src && !error.value) {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(as.value.img || unref(__nuxt_component_4)), mergeProps({
                src: __props.src,
                alt: __props.alt,
                width: sizePx.value,
                height: sizePx.value
            ...
            return [
              __props.src && !error.value ? (openBlock(), createBlock(resolveDynamicComponent(as.value.img || unref(__nuxt_component_4)), mergeProps({
                key: 0,
                src: __props.src,
                alt: __props.alt,
                width: sizePx.value,
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_a492382add45b93319e14cad668e3015/node_modules/@nuxt/ui/dist/runtime/components/Avatar.vue");
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_a492382add45b93319e14cad668e3015/node_modules/@nuxt/ui/dist/runtime/components/LinkBase.vue");
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_a492382add45b93319e14cad668e3015/node_modules/@nuxt/ui/dist/runtime/components/Link.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_a492382add45b93319e14cad668e3015/node_modules/@nuxt/ui/dist/runtime/components/Button.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_a492382add45b93319e14cad668e3015/node_modules/@nuxt/ui/dist/runtime/components/Progress.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_a492382add45b93319e14cad668e3015/node_modules/@nuxt/ui/dist/runtime/components/Toast.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_a492382add45b93319e14cad668e3015/node_modules/@nuxt/ui/dist/runtime/components/Toaster.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_a492382add45b93319e14cad668e3015/node_modules/@nuxt/ui/dist/runtime/components/OverlayProvider.vue");
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_a492382add45b93319e14cad668e3015/node_modules/@nuxt/ui/dist/runtime/components/App.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_0 = Object.assign(_sfc_main$3, { __name: "UApp" });
const layouts = {
  "dashboard-layout": defineAsyncComponent(() => import('./dashboard-layout-D-kMVpZK.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-DQjGaydX.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CAAIuYut.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BB5jmtyZ.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.2.2_@parcel+watcher@_3fb7f493dcb3f5b51f6e5659a8c89bdc/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.2.2_@parcel+watcher@_3fb7f493dcb3f5b51f6e5659a8c89bdc/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { injectTooltipProviderContext as $, useToast as A, useFieldGroup as B, useComponentIcons as C, _sfc_main$b as D, looseToNumber as E, useRoute as F, tryOnBeforeUnmount as G, injectConfigProviderContext as H, refAutoReset as I, createEventHook as J, getActiveElement as K, AUTOFOCUS_ON_MOUNT as L, focusFirst as M, getTabbableCandidates as N, focus as O, Primitive as P, AUTOFOCUS_ON_UNMOUNT as Q, EVENT_OPTIONS as R, getTabbableEdges as S, useEmitAsProps as T, Teleport_default as U, VisuallyHidden_default as V, useForwardPropsEmits as W, reactiveOmit as X, syncRef as Y, isClient as Z, _export_sfc as _, __nuxt_component_0$1 as a, useNuxtApp as a0, useRequestEvent as a1, usePortal as a2, isArrayOfArray as a3, get as a4, _sfc_main$9 as a5, pickLinkProps as a6, _sfc_main$a as a7, omit as a8, useState as a9, useLocale as b, useAppConfig as c, useForwardProps as d, entry_default as default, _sfc_main$8 as e, __nuxt_component_4 as f, _sfc_main$e as g, fetchDefaults as h, useAsyncData as i, useRequestFetch as j, useCollection as k, usePrimitiveElement as l, createContext as m, navigateTo as n, useForwardExpose as o, isNullish as p, Presence_default as q, formBusInjectionKey as r, formStateInjectionKey as s, tv as t, useHead as u, formErrorsInjectionKey as v, formInputsInjectionKey as w, formLoadingInjectionKey as x, formOptionsInjectionKey as y, useFormField as z };
