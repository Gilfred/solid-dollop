import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { v2 } from 'cloudinary';
...
storage.mount('images', unstorage_47drivers_47fs({"driver":"fs","base":"./public/images"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "78c6a7d1-31e9-4821-a69e-2db6778ae6fa",
...
(function (exports$1) {
	...
	*/
	...
	exports$1.Prisma.CategoryScalarFieldEnum = {
	  id: 'id',
	  name: 'name',
	  slug: 'slug',
	...
	exports$1.Prisma.SubCategoryScalarFieldEnum = {
	  id: 'id',
	  name: 'name',
	  slug: 'slug',
	  description: 'description',
	...
	exports$1.Prisma.PostScalarFieldEnum = {
	  id: 'id',
	  title: 'title',
	  content: 'content',
	  slug: 'slug',
	...
	exports$1.Prisma.SessionScalarFieldEnum = {
	  id: 'id',
	  expiresAt: 'expiresAt',
	  token: 'token',
	  createdAt: 'createdAt',
	...
	exports$1.Prisma.AccountScalarFieldEnum = {
	  id: 'id',
	  accountId: 'accountId',
	...
	exports$1.Prisma.VerificationScalarFieldEnum = {
	  id: 'id',
	...
	const config = {
	  "generator": {
	    ...
	    "output": {
	      "value": "C:\\Users\\LENOVO\\Desktop\\Nuxt JS\\solid-dollop\\node_modules\\.pnpm\\@prisma+client@6.19.2_prism_1ccbb5e8b5d076c2536d6097801e09da\\node_modules\\@prisma\\client",
	      "fromEnvVar": null
	    },
	    "config": {
	      "engineType": "library"
	  ...
	  "inlineSchemaHash": "99f6d11449fd41f173c108508fdc865b29851595a1f1fea99ca302e4585644fe",
	  "copyEngine": true
	};
	...
	if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
	  const alternativePaths = [
	    "node_modules/.pnpm/@prisma+client@6.19.2_prism_1ccbb5e8b5d076c2536d6097801e09da/node_modules/.prisma/client",
	    ".pnpm/@prisma+client@6.19.2_prism_1ccbb5e8b5d076c2536d6097801e09da/node_modules/.prisma/client",
	  ];
	...
	defineDmmfProperty(exports$1.Prisma, config.runtimeDataModel);
	...
	path.join(process.cwd(), "node_modules/.pnpm/@prisma+client@6.19.2_prism_1ccbb5e8b5d076c2536d6097801e09da/node_modules/.prisma/client/query_engine-windows.dll.node");
	// file annotations for bundling tools to include these files
	path.join(__dirname, "schema.prisma");
	path.join(process.cwd(), "node_modules/.pnpm/@prisma+client@6.19.2_prism_1ccbb5e8b5d076c2536d6097801e09da/node_modules/.prisma/client/schema.prisma"); 
} (client));

/* !!! This is code generated by Prisma. Do not edit directly. !!!
/* eslint-disable */
// biome-ignore-all lint: generated file
var _default$1 = { ...client };

var _default = {
  ..._default$1,
};

const pkg = /*@__PURE__*/getDefaultExportFromCjs(_default);
...
const _K4wm6f = defineEventHandler(async (event) => {
  ...
  console.log("Session r\xE9cup\xE9r\xE9e c\xF4t\xE9 serveur :", session);
...
const _OZi5Cq = defineCachedEventHandler(async (event) => {
...
const _FOpYbc = lazyEventHandler(() => {
...
const _lazy_AhH3Fs = () => import('../routes/api/auth/_..._.mjs');
const _lazy_s8Apok = () => import('../routes/api/auth/_...all_.mjs');
const _lazy_7rA80T = () => import('../routes/api/index.get.mjs');
const _lazy_lpPxUa = () => import('../routes/api/me.get.mjs');
const _lazy_oI77Mw = () => import('../routes/api/posts/_id_.delete.mjs');
const _lazy_SDGzvQ = () => import('../routes/api/posts/_id_.get.mjs');
const _lazy_989ZFe = () => import('../routes/api/posts/_id_.put.mjs');
const _lazy_yZu8ca = () => import('../routes/api/index.get2.mjs');
const _lazy_sVuAvq = () => import('../routes/api/index.post.mjs');
const _lazy_lSsKiS = () => import('../routes/api/subCategory/_id_.delete.mjs');
const _lazy_tbFUB_ = () => import('../routes/api/subCategory/_id_.get.mjs');
const _lazy_A3t2jz = () => import('../routes/api/subCategory/_id_.put.mjs');
const _lazy_dG7wDc = () => import('../routes/api/index.get3.mjs');
const _lazy_XsnZQc = () => import('../routes/api/index.post2.mjs');
const _lazy_mPorNR = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _K4wm6f, lazy: false, middleware: true, method: undefined },
  { route: '/api/auth/**', handler: _lazy_AhH3Fs, lazy: true, middleware: false, method: undefined },
  { route: '/api/auth/**:all', handler: _lazy_s8Apok, lazy: true, middleware: false, method: undefined },
  { route: '/api/categories', handler: _lazy_7rA80T, lazy: true, middleware: false, method: "get" },
  { route: '/api/me', handler: _lazy_lpPxUa, lazy: true, middleware: false, method: "get" },
  ...
  { route: '/api/subCategory/:id', handler: _lazy_lSsKiS, lazy: true, middleware: false, method: "delete" },
  { route: '/api/subCategory/:id', handler: _lazy_tbFUB_, lazy: true, middleware: false, method: "get" },
  { route: '/api/subCategory/:id', handler: _lazy_A3t2jz, lazy: true, middleware: false, method: "put" },
  { route: '/api/subCategory', handler: _lazy_dG7wDc, lazy: true, middleware: false, method: "get" },
  { route: '/api/subCategory', handler: _lazy_XsnZQc, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_mPorNR, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _OZi5Cq, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _FOpYbc, lazy: false, middleware: false, method: undefined },
  { route: '/uploads/**', handler: _lazy_mPorNR, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_mPorNR, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, isScriptProtocol as A, joinURL as B, sanitizeStatusCode as C, withTrailingSlash as D, withoutTrailingSlash as E, getContext as F, withLeadingSlash as G, parseURL as H, baseURL as I, createHooks as J, executeAsync as K, toRouteMatcher as L, createRouter$1 as M, encodeParam as N, encodePath as O, hash$1 as P, isEqual as Q, upperFirst as R, parse as S, getRequestHeader as T, setCookie as U, getCookie as V, deleteCookie as W, auth as a, toWebRequest as b, prisma as c, defineEventHandler as d, createError$1 as e, readMultipartFormData as f, getRouteRulesForPath as g, buildAssetsURL as h, useRuntimeConfig as i, getResponseStatusText as j, getResponseStatus as k, defineRenderHandler as l, publicAssetsURL as m, getQuery as n, destr as o, parseQuery as p, getRouteRules as q, readBody as r, setResponseStatus as s, toNodeListener as t, useNitroApp as u, defu as v, withQuery as w, klona as x, defuFn as y, hasProtocol as z };
